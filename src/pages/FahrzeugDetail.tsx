...
import AddRuecklagenDialog from '@/components/AddRuecklagenDialog';
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
const FahrzeugDetail = () => {
  ...
  const handleAddRuecklagen = (ruecklage: { beschreibung: string; interval: string; betrag: string }) => {
    // Here you would typically handle adding the Rücklage to your state/database
    console.log('Neue Rücklage:', ruecklage);
  };
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <AddRuecklagenDialog onSubmit={handleAddRuecklagen} />
                  </div>
                </div>
              </CardHeader>
