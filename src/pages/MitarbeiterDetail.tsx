        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <p className="text-lg">{mitarbeiter.name}</p>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-600">E-Mail</label>
              <p className="text-lg">{mitarbeiter.email}</p>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-600">Telefon</label>
              <p className="text-lg">{mitarbeiter.telefon}</p>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-600">Status</label>
              <div className="flex items-center">
                <div className="w-3 h-3 bg-green-500 rounded-full mr-2"></div>
                <span className="capitalize">{mitarbeiter.status}</span>
              </div>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-600">Eingestellt am</label>
              <p className="text-lg">{mitarbeiter.eingestellt}</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <p className="text-lg font-semibold">{mitarbeiter.provision}</p>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-600">Netto-Gehalt</label>
              <p className="text-lg font-semibold">{mitarbeiter.nettoGehalt}</p>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-600">Sollfahrten</label>
              <p className="text-lg">{mitarbeiter.sollfahrten}</p>
            </div>
          </CardContent>
        </Card>
      </div>
